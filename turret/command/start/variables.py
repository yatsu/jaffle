...
class VariablesNamespace(object):
    """
    Variables namespace for loading turret.hcl.
    """
    ...
    def _get_python_type(self, name, type_str, default):
        ...
        type_str : str or None
            Type name defined in turret.hcl. It may be ``_NOT_FOUND``.
        default : object
            Default value defined in turret.hcl. It may be ``_NOT_FOUND``.
    ...
    def __getattr__(self, name):
        ...
        syntax in turret.hcl such as ``${var.foo}``.
